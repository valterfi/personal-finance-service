...
public class MessageService {
    ...
    public void process(Message message) {
        try {
            ...
            sendInsightMessage(savedTransaction, expectedSpendingToday);
        } catch (Exception exception) {
            log.error("Failed to process message subject={}", MessageUtils.safeSubject(message), exception);
        }
    }

    private void sendInsightMessage(Transaction savedTransaction, BigDecimal expectedSpendingToday) {
        ...
        String contentVariables = toInsightContentVariables(savedTransaction, expectedSpendingToday);
    ...
    private String toInsightContentVariables(Transaction transaction, BigDecimal expectedSpendingToday) {
        ...
        SpendingPaceInsight insight = resolveSpendingPaceInsight(currentBalance, targetBalance, difference, expectedSpendingToday);
