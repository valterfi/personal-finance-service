...
class MessageParserTest {
    ...
    private static final String SAMPLE_BODY = """
            ...
            18/04/2026 Compra no crédito aprovada Sua compra no cartão final 7396 no valor de R$ 1202,44, dia 18/04/2026 às 13:59, em CARREFOUR TTE 43 SAO PAULO BRA, foi aprovada.
            """;
    private static final String SAMPLE_BODY_WITH_EXTRA_SPACES =
            "21/04/2026  Compra no crédito aprovada Sua compra no cartão final 7396 no valor de R$ 84,83, dia 21/04/2026 às 13:38, em SAMS RADIAL 4918       SAO PAULO     BRA, foi aprovada. ";
    ...
    void shouldParseTransactionWhenMessageContainsIrregularSpaces() {
        ...
        assertEquals(new BigDecimal("84.83"), transaction.getAmount());
        assertEquals("7396", transaction.getCard());
    }
}
